...
function showMenu() {
  ...
  function kethalo(){new TypeIt("#halo", {strings: ["" + ""], startDelay: 50, speed: 40, waitUntilVisible: true, afterComplete: function(){halo.innerHTML = "";setTimeout(bqmuncul,200);},}).go();}
